...
def Monitor ():
    ...
    while Available_Replicas != Operational_Replicas and Available_Replicas is not None and Operational_Replicas is not None:               # To accomodate pod initialization time, keep trying until pod running
        ...
        # TODO: kubectl top pod command will exit with non-return but not caught by except to return None, it returns an empty string instead
...
def adservice(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/adservice.xlsx')
