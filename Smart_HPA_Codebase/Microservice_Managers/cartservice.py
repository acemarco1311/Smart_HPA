...
def Monitor ():
    ...
    while Available_Replicas != Operational_Replicas and Available_Replicas is not None and Operational_Replicas is not None:               # To accomodate pod initialization time, keep trying until pod running
        ...
        #TODO: kubectl top pods inconsistency
...
def cartservice(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/cartservice.xlsx')
    ...
    #workbook.save('./Knowledge_Base/cartservice.xlsx')

    write_content('./Knowledge_Base/cartservice.txt', Test_Time, cpu_percentage, current_replicas, desired_replica, max_replica, scaling_action)
