...
def currencyservice(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/currencyservice.xlsx')
    ...
    #workbook.save('./Knowledge_Base/currencyservice.xlsx')

    write_content('./Knowledge_Base/currencyservice.txt', Test_Time, cpu_percentage, current_replicas, desired_replica, max_replica, scaling_action)
