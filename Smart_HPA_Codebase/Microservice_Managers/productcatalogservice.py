...
def productcatalogservice(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/productcatalogservice.xlsx')
    ...
    #workbook.save('./Knowledge_Base/productcatalogservice.xlsx')

    write_content('./Knowledge_Base/productcatalogservice.txt', Test_Time, cpu_percentage, current_replicas, desired_replica, max_replica, scaling_action)
