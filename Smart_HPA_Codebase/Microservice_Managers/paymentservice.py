...
def paymentservice(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/paymentservice.xlsx')
    ...
    #workbook.save('./Knowledge_Base/paymentservice.xlsx')

    write_content('./Knowledge_Base/paymentservice.txt', Test_Time, cpu_percentage, current_replicas, desired_replica, max_replica, scaling_action)
