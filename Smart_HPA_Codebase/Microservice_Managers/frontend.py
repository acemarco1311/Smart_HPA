...
def frontend(Test_Time):
    ...
    #workbook = load_workbook('./Knowledge_Base/frontend.xlsx')
    ...
    #workbook.save('./Knowledge_Base/frontend.xlsx')

    write_content('./Knowledge_Base/frontend.txt', Test_Time, cpu_percentage, current_replicas, desired_replica, max_replica, scaling_action)
